    ...
    if(data=="u")
{
        ...
        ui->tabWidget->setCurrentIndex(0);
               ...
               //player->setSource(QUrl::fromLocalFile("C:/Users/msi/Desktop/dsq/untitled3d/rsc/ajouterestactive.mp3"));
        ...
        player->setSource(QUrl::fromLocalFile("C:/Users/msi/Desktop/dsq/untitled3d/rsc/affichageactive.mp3"));
        audioOutput->setVolume(50);
        player->play();
                   ...
                   player->setSource(QUrl::fromLocalFile("C:/Users/msi/Desktop/dsq/untitled3d/rsc/enregistrementactivee.mp3"));
                   audioOutput->setVolume(50);
                   player->play();
...
on_pushButton_2_clicked();
        ...
        player->setSource(QUrl::fromLocalFile("C:/Users/msi/Desktop/dsq/untitled3d/rsc/statistiqueestactivee.mp3"));
        audioOutput->setVolume(50);
        player->play();
      ...
      on_pushButton_clicked();
                ...
                player->setSource(QUrl::fromLocalFile("C:/Users/msi/Desktop/dsq/untitled3d/rsc/extpourparleactive.mp3"));
                audioOutput->setVolume(50);
                player->play();
        ...
        player->setSource(QUrl::fromLocalFile("C:/Users/msi/Desktop/dsq/untitled3d/rsc/historiqueacti.mp3"));
        audioOutput->setVolume(50);
        player->play();
...
on_supp_clicked() ;   }
            ...
            player->setSource(QUrl::fromLocalFile("C:/Users/msi/Desktop/dsq/untitled3d/rsc/envoidemailacti.mp3"));
            audioOutput->setVolume(50);
            player->play();
        ...
        //ui->tabWidget->setCurrentIndex(7);
        player->setSource(QUrl::fromLocalFile("C:/Users/msi/Desktop/dsq/untitled3d/rsc/pdfactive.mp3"));
        audioOutput->setVolume(50);
        player->play();
        ...
        //ui->tabWidget->setCurrentIndex(7);
        player->setSource(QUrl::fromLocalFile("C:/Users/msi/Desktop/dsq/untitled3d/rsc/impractie.mp3"));
        audioOutput->setVolume(50);
        player->play();
on_pushButton_15_clicked();
          ...
          ui->tabWidget->setCurrentIndex(1);
          player->setSource(QUrl::fromLocalFile("C:/Users/msi/Desktop/dsq/untitled3d/rsc/supprimertoutacti.mp3"));
          audioOutput->setVolume(50);
          player->play();
         on_pushButton_Sui_m_2_clicked();
...
if(test)
{
    ...
    QMessageBox::information(nullptr, QObject::tr("database is open"),
                QObject::tr("supp successful.\n"
                            "Click Cancel to exit."), QMessageBox::Cancel);
    player->setSource(QUrl::fromLocalFile("C:/Users/msi/Desktop/dsq/untitled3d/rsc/supprimersucc.mp3"));
    audioOutput->setVolume(50);
    player->play();
    ...
    if(test)
    {
        ...
        QMessageBox::information(nullptr, QObject::tr("database is open"),
                    QObject::tr("suppt successful.\n"
                                "Click Cancel to exit."), QMessageBox::Cancel);
        player->setSource(QUrl::fromLocalFile("C:/Users/msi/Desktop/dsq/untitled3d/rsc/supprimertsucc.mp3"));
            audioOutput->setVolume(50);
            player->play();
...
ui->tableWidget->setItem(-1, 2,item);
   ...
   //double pa=();
    QString paa=QString::number((float)nbt)+"%";
    item5->setText(paa);
